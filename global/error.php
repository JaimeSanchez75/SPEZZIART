...
$mensaje = $codigo === 404 ? "Lo sentimos, la página que buscas no existe." : ($codigo === 403 ? "No tienes permisos para acceder a esta página." : "Ha ocurrido un error inesperado. Intenta más tarde.");?>
<!DOCTYPE html>
<html lang="es">
    <head>
        <meta charset="UTF-8">
