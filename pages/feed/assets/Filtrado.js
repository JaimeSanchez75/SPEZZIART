...
document.addEventListener('DOMContentLoaded', function() 
{
    ...
    window.renderChips = function() 
    {
        ...
        const renderInContainer = (wrapper, extraBadge) => 
        {
            ...
            const createChipElement = (tag, includeClose = true) =>
            {
            ...
            wrapper.querySelectorAll('.chip-close').forEach(btn =>{ btn.addEventListener('click', e => { e.stopPropagation(); window.eliminarEtiqueta(btn.dataset.tag);});});
