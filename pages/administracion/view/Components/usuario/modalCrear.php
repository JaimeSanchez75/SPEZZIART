...
<div class="modal fade" id="modalCrearAdmin" tabindex="-1" aria-labelledby="modalCrearAdminLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content position-relative overflow-hidden border-0 rounded-4 shadow-sm">
            ...
            <form id="formCrearAdmin" action="/pages/administracion/usuarios/crear" method="post">
                <input type="hidden" name="csrf_token" value="<?= csrf_token() ?>">
                <div class="modal-body ps-4 pe-4 pt-0 pb-2 position-relative z-1">
                    <!-- Hero -->
                    <div class="d-flex gap-3 align-items-center mb-4">
                        <div><span><i class="bi bi-person-plus texto-rojo iconos bg-rojoClaro p-3 rounded-3 perfilUsuarioGrande"></i></span></div>
                        <div>
                            <h3 class="fw-bold subtitulo letraRomana m-0" id="modalCrearAdminLabel">Crear Administrador</h3>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group rounded-3 overflow-hidden">
                            ...
                            <input type="text" class="form-control texto text-secondary border-start-0 rounded-3 rounded-start-0" id="apodo" name="datosUsuario[apodo]" placeholder="Escribe el apodo" required minlength="2" maxlength="60">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group rounded-3 overflow-hidden">
                            ...
                            <input type="text" class="form-control texto text-secondary border-start-0 rounded-3 rounded-start-0" id="username" name="datosUsuario[username]" placeholder="Ejemplo: juan123" required minlength="3" maxlength="30" pattern="^[a-zA-Z0-9_\.]+$" title="Solo letras, números, guion bajo y punto.">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group rounded-3 overflow-hidden">
                            ...
                            <input type="email" class="form-control texto text-secondary border-start-0 rounded-3 rounded-start-0" id="email" name="datosUsuario[email]" placeholder="usuario@ejemplo.com" required maxlength="120">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group rounded-3 overflow-hidden">
                            ...
                            <input type="password" class="form-control texto text-secondary border-start-0 rounded-3 rounded-start-0" id="password" name="datosUsuario[password]" placeholder="********" required minlength="6" maxlength="100">
