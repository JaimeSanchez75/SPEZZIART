    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content position-relative overflow-hidden border-0 rounded-4 shadow-sm">
            ...
            <div class="modal-body text-center p-4 pt-0 position-relative z-1">
                ...
                <h3 class="fw-bold letraRomana subtitulo m-0 mb-2">Eliminar usuario</h3>
                <p class="texto text-dark mb-1">¿Seguro que deseas eliminar a <strong id="nombreUsuario" class="text-break"></strong>?</p>
            ...
            <div class="modal-footer border-0 d-flex justify-content-center gap-2 px-4 pb-4 position-relative z-1">
                ...
                <button type="button" class="bg-rojo text-white border-0 p-2 texto rounded-4 px-4" id="EliminarUsuario">Eliminar usuario</button>
            </div>
        </div>
    </div>
</div>
