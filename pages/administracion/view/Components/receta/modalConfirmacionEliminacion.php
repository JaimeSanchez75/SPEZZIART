...
<div class="modal fade" id="eliminarRecetaModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content position-relative overflow-hidden border-0 rounded-4 shadow-sm">
            ...
            <div class="modal-body text-center p-4 pt-0 position-relative z-1">
                ...
                <h3 class="fw-bold letraRomana subtitulo m-0 mb-2">Eliminar receta</h3>
                <p class="texto text-dark mb-1">¿Seguro que deseas eliminar <strong id="tituloReceta"></strong>?</p>
            ...
            <div class="modal-footer border-0 d-flex justify-content-center gap-2 px-4 pb-4 position-relative z-1">
                ...
                <button type="button" class="bg-rojo text-white border-0 p-2 texto rounded-4 px-4" id="eliminarReceta">Eliminar receta</button>
            </div>
        </div>
    </div>
</div>
<script src="/pages/administracion/assets/receta/eliminarReceta.js"></script>
