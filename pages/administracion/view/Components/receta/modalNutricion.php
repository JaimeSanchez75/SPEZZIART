    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content position-relative overflow-hidden border-0 rounded-4 shadow-sm">
            ...
            <div class="modal-body ps-4 pe-4 pt-0 pb-2 position-relative z-1">
                ...
                <div class="d-flex gap-3 align-items-center mb-4">
                    ...
                    <div>
                        ...
                        <p class="texto text-secondary m-0">Información nutricional total de la receta.</p>
                    </div>
                </div>
                <div class="mb-3">
                    ...
                    <div class="input-group rounded-3 overflow-hidden">
                        ...
                        <input type="number" min="0" class="form-control texto text-secondary border-start-0 rounded-3 rounded-start-0" id="calorias" placeholder="0">
                    </div>
                </div>
                <div class="mb-3">
                    ...
                    <div class="input-group rounded-3 overflow-hidden">
                        ...
                        <input type="number" min="0" class="form-control texto text-secondary border-start-0 rounded-3 rounded-start-0" id="proteina" placeholder="0">
                    </div>
                </div>
                <div class="mb-3">
                    ...
                    <div class="input-group rounded-3 overflow-hidden">
                        ...
                        <input type="number" min="0" class="form-control texto text-secondary border-start-0 rounded-3 rounded-start-0" id="carbohidratos" placeholder="0">
                    </div>
                </div>
                <div class="mb-3">
                    ...
                    <div class="input-group rounded-3 overflow-hidden">
                        ...
                        <input type="number" min="0" class="form-control texto text-secondary border-start-0 rounded-3 rounded-start-0" id="grasas" placeholder="0">
                    </div>
                </div>
            </div>
            <div class="modal-footer border-0 px-4 pb-4 position-relative z-1">
                ...
                <button type="button" class="bg-rojo text-white border-0 p-2 texto rounded-4 px-4" id="btnNutricion">Guardar</button>
            </div>
        </div>
    </div>
</div>
