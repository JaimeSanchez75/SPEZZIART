...
<head>
    ...
    <title>Nueva Contraseña | Spezziart</title>
    <!-- reCAPTCHA v3 -->
...
<body class=" container d-flex justify-content-center align-items-center vh-100">
    <div class="row justify-content-center align-items-center  g-0 vh-100">
        ...
        <div class="col-12 col-md-6">
            <div class="p-5 sombra border rounded rounded-5 bg-white efectoEscala">
                ...
                <form id="reset-form" method="POST" action="/pages/login/actualizarContrasena">
                    <!-- titulo -->
                    <div class="d-flex gap-3 align-items-center mb-4">
                        ...
                        <div>
                            <h3 class="modal-title fw-bold subtitulo letraRomana m-0">Nueva Contraseña</h3>
                            <p class="texto text-secondary m-0">Crea una contraseña segura para tu cuenta.</p>
                        </div>
                    </div>

                    <input type="hidden" name="csrf_token" value="<?= htmlspecialchars($csrfToken, ENT_QUOTES, 'UTF-8') ?>">
                    <input type="hidden" name="token" value="<?= htmlspecialchars($token, ENT_QUOTES, 'UTF-8') ?>">
                    <input type="hidden" name="datos[email]" value="<?= htmlspecialchars($usuario['Email'], ENT_QUOTES, 'UTF-8') ?>">

                    <!-- contraseña -->
                    <div class="mb-3">
                        <label class="form-label text-dark fw-semibold">Nueva contraseña</label>
                    ...
                    <div class="text-center mt-3">
                        <a href="/pages/login" class="texto text-secondary fw-semibold text-decoration-none btns border-0 p-2 texto rounded-4 px-4">
                            Volver al Login
                        </a>
                    </div>
                </form>
    ...
    <script src="/pages/login/assets/Resetear.js">
