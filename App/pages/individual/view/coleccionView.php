...
<div class="container mt-4">
        ...
        <div class="header-item item-logo">
            <h3 class="fw-bold m-0">
                ...
                <span class="ms-2 text-dark">
                    | Colección: <?= htmlspecialchars($coleccion['Nombre'] ?? '') ?>
                </span>
            </h3>
        </div>

        <div class="header-item item-search">
            <a href="/App/pages/individual" class="btn btn-secondary">
                ← Volver
            </a>
        </div>
    </div>
    ...
    <div>
        <?php $this->renderLista($recetas, $coleccion['ID_Coleccion']); ?>
    </div>
...
<?php
    ...
    private function renderLista($recetas, $idColeccion) {
        ...
        if (empty($recetas)) {
            echo "<p class='text-muted ps-2'>No hay recetas en esta colección todavía.</p>";
            return;
        }
        ...
        ?>
            <div id="receta-<?= $idReceta ?>"
                 class="card feed-card mb-4 p-3 border-0 shadow-sm rounded-4 receta-card"
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        <a href="/App/pages/individual/ver?id=<?= $idReceta ?>">
                            <?php if(!empty($imagen)): ?>
                                <img src="/App/uploads/<?= htmlspecialchars($imagen) ?>"
                                     class="feed-img rounded-3"
                                     style="cursor:pointer;">
                            <?php else: ?>
                                <div class="feed-img bg-light d-flex align-items-center justify-content-center text-muted border rounded-3">
                                    Sin imagen
                                </div>
                            <?php endif; ?>
                        </a>
                    ...
                    <div class="col-md-8 d-flex flex-column justify-content-between">
                        ...
                        <div class="d-flex justify-content-end gap-3 align-items-center">
                            ...
                            <!-- EDITAR -->
                            <a href="/App/pages/individual/crear?id=<?= $idReceta ?>">
